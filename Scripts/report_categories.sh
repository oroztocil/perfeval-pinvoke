...
bash run_category.sh CS_Void_Empty
bash run_category.sh CS_Strings_Empty_In
bash run_category.sh CS_Arrays_InOut
bash run_category.sh CS_Structs_Blittable
bash run_category.sh CS_Structs_NonBlittable
bash run_category.sh CS_Mixed
