...
{
    [CustomMarshaller(typeof(NonBlittableStruct), MarshalMode.Default, typeof(NonBlittableStatelessMarshaller))]
    public static unsafe class NonBlittableStatelessMarshaller
    {
